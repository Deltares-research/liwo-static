<template>
  <div class="toegankelijkheid site-main">
    <div>
      <section class="section">
        <h2 data-class="section-head">Toegankelijkheid</h2>
        <p>Rijkswaterstaat wil dat iedereen alle informatie op deze website goed kan gebruiken. Daarom besteden we veel aandacht aan gebruiksvriendelijkheid, toegankelijkheid en vindbaarheid. <a href="https://wetten.overheid.nl/BWBR0040936/2018-07-01" rel="noopener noreferrer" target="_blank">In het Tijdelijk besluit digitale toegankelijkheid overheid</a> is bepaald dat overheidssites moeten voldoen aan toegankelijkheidseisen zoals vastgelegd in EN 301 549/WCAG 2.1 en daarover verantwoordelijkheid moeten afleggen in een gepubliceerde toegankelijkheidsverklaring.</p>
        ...
        <p>Toegankelijkheidsverklaringen van andere websites dan Basisinformatie-overstromingen.nl die eveneens onder verantwoordelijkheid vallen van Rijkswaterstaat, kunt u bekijken in het <a href="https://www.toegankelijkheidsverklaring.nl/register" rel="noopener noreferrer" target="_blank">register van toegankelijkheidsverklaringen</a>.</p>

        <h2 data-class="section-head">Problemen met toegankelijkheid melden</h2>
        <p>Heeft u vragen of opmerkingen? Of wilt u een pagina gebruiken op deze website die niet toegankelijk blijkt? Neem dan <a href="https://www.helpdeskwater.nl/stel-vraag/" rel="noopener noreferrer" target="_blank">contact met ons</a> op</p>
      </section>
    </div>
  </div>
</template>
